...
const params = defineProps<WorkCard>()
...
<template>
    <div class="flex flex-col justify-center items-start md:flex-row gap-4">
        ...
        <div
            ...
            <ul class="text-xs md:text-base flex flex-col md:gap-2">
                ...
                <li v-if="params.duration" class="flex gap-2 items-center">
        ...
        <div class="w-full flex flex-col items-center">
            ...
            <p class="text-xs md:text-base mb-2 max-w-[800px]">{{ params.description }}
                <a class="text-sky-800" :href="params.seeMoreUrl">Ver
                    más.</a>
            </p>
            <div class="w-full max-w-[800px]" v-if="diplomaUrl">
                <h3 class="text-xs md:text-lg lg:text-xl font-bold mb-2">Diploma</h3>
                <!-- diploma real -->
                <div
                    @click="showDiplomaModal = true"
    ...
    <Teleport to="body">
        <Transition name="modal-fade">
            <div v-if="showDiplomaModal"
                @click="showDiplomaModal = false"
